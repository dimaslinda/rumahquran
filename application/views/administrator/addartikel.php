...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url(); ?>administrator/addartikel">Tambah Artikel</a></li>
        </ol>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="<?= base_url(); ?>administrator/addartikel" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sub_judul" aria-describedby="Text" placeholder="Masukan Sub Judul Artikel" name="sub_judul" value="<?= set_value('sub_judul'); ?>">
                            <?= form_error('sub_judul', '<small class="text-danger">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="keterangan_gambar" name="user" value="<?= $user['nama_lengkap']; ?>">
                        </div>
