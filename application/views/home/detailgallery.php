                ...
                <div class="col">
                    ...
                    <div class="col" id="sidebarbbq">
                        <header class="section-headerbbq">
                            <h3>Gallery Lainnya</h3>
                        </header>
                        <div class="uk-panel uk-panel-scrollable" style="height: 366px;resize: none;margin:-22px auto;">
                            <ul class="uk-list">
                                <?php foreach ($gallery as $gl) : ?>
                                    <li>
                                        <img src="<?= base_url(); ?>assets/img/artikel/<?= $gl['gambar']; ?>" style="width: 80px;" alt="">
                                        <a href="<?= base_url(); ?>home/detailgallery/<?= $gl['id_gallery']; ?>" style="font-family: Quicksand;font-style: normal;font-weight: 500;font-size: 16px;line-height: 20px;text-align: justify;color: #666666;"><?= $gl['judul']; ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
